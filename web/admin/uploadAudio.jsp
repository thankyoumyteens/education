...
<div class="dialog-wrapper" id="dialogWrapper">
    <form onsubmit="check" action="<%=request.getContextPath() %>/adminUploadAudio" method="post" enctype="multipart/form-data">
        <div class="login-dialog">
            ...
            <%--</div>--%>
            <div class="login-item form-group">
                <label>录音(只支持mp3格式)</label>
                <input type="file" name="courseUpload" accept="audio/*" />
            </div>
            <%--<div class="login-item form-group">--%>
                <%--<label>类型</label>--%>
